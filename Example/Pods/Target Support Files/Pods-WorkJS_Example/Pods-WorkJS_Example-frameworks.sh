...
<<<<<<< HEAD
  ...
  install_framework "${PODS_ROOT}/../../Products/FMDB.framework"
  install_framework "${PODS_ROOT}/../../Products/image_picker.framework"
  install_framework "${PODS_ROOT}/../../Products/install_plugin.framework"
  install_framework "${PODS_ROOT}/../../Products/ota_update.framework"
  install_framework "${PODS_ROOT}/../../Products/package_info.framework"
  install_framework "${PODS_ROOT}/../../Products/path_provider.framework"
  install_framework "${PODS_ROOT}/../../Products/SDWebImage.framework"
  install_framework "${PODS_ROOT}/../../Products/shared_preferences.framework"
  install_framework "${PODS_ROOT}/../../Products/simple_rsa.framework"
  install_framework "${PODS_ROOT}/../../Products/sqflite.framework"
  install_framework "${PODS_ROOT}/../../Products/SwiftyGif.framework"
