...
#ifndef SWIFTYGIF_SWIFT_H
#define SWIFTYGIF_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftyGif",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class UIImageView;

SWIFT_PROTOCOL("_TtP9SwiftyGif17SwiftyGifDelegate_")
